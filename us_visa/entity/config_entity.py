...
from us_visa.constants import (
    PIPELINE_NAME, ARTIFACT_DIR, DATA_INGESTION_DIR_NAME, 
    DATA_INGESTION_FEATURE_STORE_DIR, FILE_NAME, 
    DATA_INGESTION_INGESTED_DIR, TRAIN_FILE_NAME, 
    TEST_FILE_NAME, DATA_INGESTION_TRAIN_TEST_SPLIT_RATIO, 
    DATA_INGESTION_COLLECTION_NAME, DATA_VALIDATION_DIR_NAME,
